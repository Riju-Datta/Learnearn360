  ...
  return (
    <div className="bg-white/3 border border-white/10 rounded-2xl p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-500 text-sm">Sign in to continue learning and earning</p>
      </div>
      ...
      <div className="relative mb-4">
        ...
        <div className="relative flex justify-center text-xs">
          <span className="bg-[#030712] px-3 text-gray-600">or continue with email</span>
        </div>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            <Input
              ...
              placeholder="••••••••"
              className="bg-white/5 border-white/10 text-white placeholder:text-gray-600 focus:border-blue-500 pr-10"
              {...register("password")}
            />
      ...
      <p className="text-center text-sm text-gray-600 mt-6">
        ...
        <Link href="/register" className="text-blue-400 hover:underline font-medium">Create one free</Link>
      </p>
    </div>
  );
}
